...
class GaussianDiffusion:
    ...
    def p_mean_variance(
        self, model, x, cond_top, struc, well, well_loc, t, clip_denoised=True, denoised_fn=None, model_kwargs=None
    ):
        """
        ...
        B, C = x.shape[:2]
        assert t.shape == (B,)
        model_output = model(x, cond_top, struc, well, well_loc, self._scale_timesteps(t), **model_kwargs)
    ...
    def _vb_terms_bpd(
        self, model, x_start, x_t, cond_top, struc, well, well_loc, t, clip_denoised=True, model_kwargs=None
    ):
        """
        ...
        out = self.p_mean_variance(
            model, x_t, cond_top, struc, well, well_loc, t, clip_denoised=clip_denoised, model_kwargs=model_kwargs
        )
    ...
    def training_losses(self, model, x_start, cond_top, struc, well, well_loc, t, model_kwargs=None, noise=None):
        """
        ...
        if self.loss_type == LossType.KL or self.loss_type == LossType.RESCALED_KL:
            ...
            model_output = model(x_t, cond_top, struc, well, well_loc, self._scale_timesteps(t), **model_kwargs)
    ...
    def calc_bpd_loop(self, model, x_start, cond_top, struc, well, well_loc, clip_denoised=True, model_kwargs=None):
        """
