...
class BasicDataset(Dataset):
    ...
    def __init__(self, paths, depth_size, vmax, vmin, class_cond=False):
        ...
        self.vmax = vmax               # upper velocity bound (m/s) for normalization;
                                       # passed to normalizer_vel as dmax
        self.vmin = vmin               # lower velocity bound (m/s) for normalization;
                                       # passed to normalizer_vel as dmin
    ...
    def __getitem__(self, idx):
        ...
        struc = data['ref']   # reflectivity section,  shape (nz, nx)
        nz, nx = vp.shape
        ...
        struc_bottom = struc[depth_bottom - self.depth_size + 1 : depth_bottom + 1]
