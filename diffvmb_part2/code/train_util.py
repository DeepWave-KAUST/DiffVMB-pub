...
class TrainLoop:
    ...
    def __init__(
        ...
        *,
        ...
        self.inivpcond_drop = inivpcond_drop
    ...
    def run_step(self, batch_vp, batch_cond_top, batch_inivp, batch_struc, batch_well, batch_well_loc, cond):
        """
        Execute one training iteration: forward/backward + optimization + logging.
        """
        self.forward_backward(batch_vp, batch_cond_top, batch_inivp, batch_struc,
    ...
    def forward_backward(self, batch_vp, batch_cond_top, batch_inivp,
        ...
        if random.random() < self.inivpcond_drop:
            batch_inivp = None
